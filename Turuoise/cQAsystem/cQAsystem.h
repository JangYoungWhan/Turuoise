...
public:
	...
	virtual void calculateScore( const int scoring_func, const double mv_weight, const double mp_weight, const double libenstein_weight, const double synonym_weight);
